# Generated by Django 3.2.12 on 2022-04-01 06:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('myapp', '0020_auto_20220330_0231'),
    ]

    operations = [
        migrations.CreateModel(
            name='EmbedVideoModel',
            fields=[
        ...
        migrations.AlterField(
            model_name='report4',
            name='report_file',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.detail'),
        ),
        migrations.AlterField(
            model_name='report4',
            name='report_post',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.connect'),
        ),
        migrations.AlterField(
            model_name='report4',
            name='reportid',
        ...
        migrations.AlterUniqueTogether(
            name='report4',
            unique_together={('report_user', 'report_file', 'report_post')},
        ),
    ]

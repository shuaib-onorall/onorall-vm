    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='person_name_1', to='myapp.sign')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dis_likes_on_comment', models.ManyToManyField(to='myapp.sign')),
                ('likes_on_comment', models.ManyToManyField(related_name='likes_on_comment', to='myapp.sign')),
                ('replies', models.ManyToManyField(blank=True, related_name='replies', to='myapp.Reply')),

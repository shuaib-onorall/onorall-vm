# Generated by Django 3.2.12 on 2022-03-25 07:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('for_reply', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='for_reply_1', to='myapp.sign')),
                ('person_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='person_name_1', to='myapp.sign')),
        ...
        migrations.CreateModel(
            name='LikeModelForComments',
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False, unique=True)),
                ('all_dislikes_on_comment', models.ManyToManyField(related_name='all_dislikes_on_comment', to='myapp.sign')),
                ('all_likes_on_comment', models.ManyToManyField(related_name='all_likes_on_comment', to='myapp.sign')),
            ],
        ),
        migrations.CreateModel(
            name='LikeModel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='myapp.likemodelforcomments')),

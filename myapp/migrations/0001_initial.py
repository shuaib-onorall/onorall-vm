    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.ManyToManyField(blank=True, related_name='likes_connect', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('all_likes', models.ManyToManyField(to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment_disllikes', models.ManyToManyField(blank=True, related_name='Post_comment_dislkikes', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddConstraint(
            model_name='report4',
            constraint=models.UniqueConstraint(fields=('report_user', 'report_file'), name='report_user_file'),
        ),
        migrations.AddConstraint(
            model_name='report4',
            constraint=models.UniqueConstraint(fields=('report_user', 'report_post'), name='report_user_post'),
        ),
        migrations.AddIndex(
            model_name='commentss',
            index=models.Index(fields=['user_id', 'video_id'], name='myapp_comme_user_id_19d0ef_idx'),
        ),
    ]
